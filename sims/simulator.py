...
class Boat:
    ...
    def trim(self,model):
        ...
        self.MainSuggestion = opt_sail_angle(model.relwind)
        self.JibSuggestion = opt_sail_angle(model.relwind)
...
#            print boat.angularVelocity
    ...
    def disp_HUD_info(self):
        ...
        text = myfont.render("Relative Wind: "+str(rad2deg(self.model.relwind)), 1, (0,0,0))
        text_2 = myfont.render("Boat angularVelocity: "+str(rad2deg(self.model.boat1.angularVelocity)), 1, (0,0,0))
